// https://github.com/ANVoevodin/pixijs_v5_flexible_buttons

//import { Texture } from '@pixi/core'
//import { NineSlicePlane } from '@pixi/mesh-extras'
//import { Text } from '@pixi/text'

import { Texture, NineSlicePlane, Text } from 'pixi.js'

export default class Button extends NineSlicePlane {
    constructor(settings) {
        const texture = Texture.from( settings.texture ) // 'button')
        const notScalableArea = settings.notScalableArea //20 // Indent from left, top, right and bottom sides in pixels
